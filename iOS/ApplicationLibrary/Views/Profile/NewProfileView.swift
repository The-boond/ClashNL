...
public struct NewProfileView: View {
    ...
    public init(
        ...
        _viewModel = StateObject(
            wrappedValue: NewProfileViewModel(
                importRequest: importRequest,
                localImportRequest: localImportRequest,
            ...
            Section {
                FormItem(String(localized: "Name")) {
                    TextField(
                        ...
                        prompt: Text(viewModel.profileType == .remote ? "Automatic" : "Required")
                    )
                ...
                if viewModel.profileType == .icloud {
                    ...
                    Text("File will be located at iCloud Drive/ClashNl/\(fileName)")
                } else if viewModel.profileType == .remote {
                    Text("Name will be generated from the URL when left empty.")
                }
            }
            #if os(iOS) || os(tvOS)
                Section {
