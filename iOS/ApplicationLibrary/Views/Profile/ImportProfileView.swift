                ...
                if !viewModel.selected {
                    Form {
                        Section {
                            ...
                            Text("To import configurations from your iPhone or iPad, make sure ClashNl is the **same version** on both devices and **VPN is disabled**.")
                        }

                        DevicePicker(
                            .applicationService(name: "clashnl:profile")
                        ) { endpoint in
