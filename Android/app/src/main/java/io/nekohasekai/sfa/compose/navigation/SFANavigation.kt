...
import io.nekohasekai.sfa.compose.screen.dashboard.SubscriptionsScreen
...
fun SFANavHost(
    ...
    NavHost(
        ...
        startDestination = primaryStartDestination.route,
        modifier = modifier,
    ) {
        ...
        composable(ProfileRoutes.NewProfile) {
            ...
            NewProfileScreen(
                ...
                startWithRemote = newProfileArgs.startWithRemote,
                onNavigateBack = {
