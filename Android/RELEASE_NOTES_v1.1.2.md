...
- 真机在 VPN 运行时从订阅页将 `NL` 切换到“新加坡-01”，仪表盘同步更新，实际出口验证为 `156.245.145.74 / SG · SIN`。
- 同一真机验证日本主节点出口为 `64.204.49.134 / JP · NRT`，首击自动测速得到 152–155 ms 成功结果；Wi-Fi 已恢复且测试后 VPN 已停止。
